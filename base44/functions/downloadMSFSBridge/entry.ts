    ...
    while True:
        try:
            ...
            payload = {
                ...
                "throttle_pct": avg_engine_load_pct,
                "throttle1_pct": throttle1_pct,
                "throttle2_pct": throttle2_pct,
                "thrust_lever_pct": avg_engine_load_pct,
                "thrust_lever1_pct": throttle1_pct,
                "thrust_lever2_pct": throttle2_pct,
                "gear_down": gear_down,
                "flap_ratio": flap_ratio,
                "flaps_deployed": flap_ratio >= 0.05,
                ...
                "landing_vspeed": state["touchdown_vspeed"],
