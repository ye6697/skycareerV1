...
export default function FinalApproach3D({ flight, onClose, durationSeconds = 30, phase = 'landing' }) {
  ...
  useEffect(() => {
    ...
    const skyMat = new THREE.ShaderMaterial({
      side: THREE.BackSide,
      uniforms: {
        topColor: { value: new THREE.Color(0x223552) },
        horizonColor: { value: new THREE.Color(0x6b7f9d) },
        glowColor: { value: new THREE.Color(0xffb079) },
      },
      ...
      fragmentShader: `
        ...
        void main(){
          ...
          // Soft warm horizon glow (much more subtle than dusk).
          float glow = smoothstep(0.18, -0.02, h) * smoothstep(-0.18, -0.02, h);
    ...
    scene.add(sunLight);
    const fillLight = new THREE.DirectionalLight(0x6a9ccc, 0.34);
