      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        {activeTab === 'active' && allContracts.length > 0 ?
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right">
                          ...
                          {contract.bonus_potential > 0 &&
                            <p className="text-sm text-amber-600">+${contract.bonus_potential?.toLocaleString()} Bonus</p>
                          }
                      ...
                      <div className="flex justify-end gap-2">
                        {contract.status === 'accepted' &&
                          <>
                            <Button
                              onClick={() => { setSelectedContract(contract); setIsAssignDialogOpen(true); }}
          ...
          <Card className="p-12 text-center bg-slate-800 border border-slate-700">
            ...
            <p className="text-slate-400 mb-4">Nimm einen Auftrag an, um einen Flug zu starten</p>
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <h3 className="text-xl font-semibold text-white">{contract.title}</h3>
                              <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200">Abgeschlossen</Badge>
                            </div>
                            <div className="flex items-center gap-3 text-slate-400">
                              <span className="flex items-center gap-1"><MapPin className="w-4 h-4" />{contract.departure_airport}</span>
                              <ArrowRight className="w-4 h-4" />
        ...
        {activeTab === 'failed' && failedContracts.length > 0 ?
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <h3 className="text-xl font-semibold text-white">{contract.title}</h3>
                              <Badge className="bg-red-100 text-red-700 border-red-200">Fehlgeschlagen</Badge>
                            </div>
                            <div className="flex items-center gap-3 text-slate-400">
                              <span className="flex items-center gap-1"><MapPin className="w-4 h-4" />{contract.departure_airport}</span>
                              <ArrowRight className="w-4 h-4" />
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-xs text-red-400">Nicht erhalten</p>
                          </div>
                        </div>
                      </div>
                    </Card>
          ...
          <Card className="p-12 text-center bg-slate-800 border border-slate-700">
            ...
            <p className="text-slate-400">Gut gemacht! Keine Abstürze oder Stornierungen</p>
          </Card> : null
        }
        ...
        <Dialog open={isAssignDialogOpen} onOpenChange={setIsAssignDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Wähle ein Flugzeug und weise eine Crew zu, um den Flug zu starten.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              {!isCrewComplete(selectedContract) &&
                <div className="p-3 bg-amber-900/30 border border-amber-700 rounded-lg flex items-start gap-2">
                  ...
                  <div>
                    <p className="font-medium text-amber-200">Unvollständige Crew</p>
